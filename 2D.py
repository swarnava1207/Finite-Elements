...
def assemble_load_vector(coordinates, triangles, quadrilaterals, f, g, u_d):
...
def solve(coordinates, triangles, quadrilaterals, f, g, u_d):
    A, b, u = assemble_load_vector(coordinates, triangles, quadrilaterals, f, g, u_d)
...
def main():
    ...
    # Solve the problem
    u = solve(coordinates, triangles, quadrilaterals, f, g, u_d)
